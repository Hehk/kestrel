...
use crate::{
    ...
    pull_requests::{
        ...
        PullRequestDiffFileDto, PullRequestDiffFileModeDto, PullRequestDiffFileOperationDto,
        PullRequestDiffHunkDto, PullRequestDiffLineDto, PullRequestDiffLineKindDto,
        PullRequestDiffResponse, PullRequestDto, PullRequestErrorCode, PullRequestErrorResponse,
        PullRequestFileDto, PullRequestReviewDto, PullRequestStatusDto,
        PullRequestTimelineEventDto, PullRequestTimelineReviewCommentDto, SyncPullRequestResponse,
